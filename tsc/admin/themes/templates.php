            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="/Ad/index.php">Smart-E-Learning </a>
                        ...
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="<?php echo web_root; ?>admin/modules/exercises/index.php"><i class="menu-icon icon-inbox"></i>Exercises <b class="label green pull-right">
                                    4</b> </a></li>
                                    <li><a href="<?php echo web_root; ?>smart/login.php"><i class="menu-icon icon-coffee"></i>Quiz</a>
                                </li> 
                            </ul>
                            <!--/.widget-nav-->
                            ...
                            <ul class="widget widget-menu unstyled">
                              ...
                              <!--  <li><a href="<?php echo web_root; ?>admin/modules/modstudent/index.php"><i class="menu-icon icon-bold"></i> Manage Students </a></li> -->
                                <li><a href="<?php echo web_root; ?>admin/modules/user/index.php"><i class="menu-icon icon-book"></i>Setting Users </a></li> 
                            </ul>
                            <!--/.widget-nav-->
                            <ul class="widget widget-menu unstyled"> 
